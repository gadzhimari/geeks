...
class SlideImage extends Component {
  ...
  render() {
    return (
      <div
        key={this.slide.id}
        className={`slide slide-image slide-${this.index} ${
          this.index === 0 ? 'active' : ''
        }`}
