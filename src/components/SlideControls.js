  ...
  render() {
    return (
      <div className="slider--controls">
        <button
          className="control-item control-prev hidden"
          onClick={handleControl.bind(this)}
          data-control="prev"
        >
        ...
        <button
          className="control-item control-next"
          onClick={handleControl.bind(this)}
          data-control="next"
        >
          <div
            ...
            style={{
              backgroundImage: `url(${Config.host +
                this.slide.image_thumbnail.url})`,
            }}
          />
        </button>

        <div className="image-prev shadow-image" />

        <div
          className="image-next shadow-image"
          style={{
            backgroundImage: `url(${Config.host +
              this.slide.image_thumbnail.url})`,
          }}
