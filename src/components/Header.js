        ...
        <div className="container">
          <nav className="menu-top">
            ...
            <div className="nav--left">
              ...
              >
                <span onClick={this.handleClick.bind(this)} data-class="about">
                  About Us
                </span>
              </Link>
              <Link
                ...
                className="link-shadow"
              >
                <span onClick={this.handleClick.bind(this)} data-class="games">
                  Games
                </span>
              </Link>
            </div>
            <div className="nav--center">
              <Link to="/" className="link-home">
                <Logo onClick={this.handleClick.bind(this)} data-class="home" />
              </Link>
            </div>
            <div className="nav--right">
              ...
              <Link
                ...
                className="link-shadow"
              >
                <span onClick={this.handleClick.bind(this)} data-class="blog">
                  Blog
                </span>
              </Link>
            </div>
