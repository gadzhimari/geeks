...
export function setDotNavigation() {
    ...
    function highlightLink() {
        ...
        const coords = {
            ...
            height: window.getComputedStyle(this, ':before').getPropertyValue('height'),
            top: Math.round(linkCoords.top + window.scrollY + parseInt(window.getComputedStyle(this).getPropertyValue('padding'))),
            left: linkCoords.left + window.scrollX + parseInt(window.getComputedStyle(this).getPropertyValue('padding')),
        }
    ...
    function disableHighlight() {
        ...
        const coords = {
            ...
            height: window.getComputedStyle(linkItemActive, ':before').getPropertyValue('height'),
            top: linkItemActive.getBoundingClientRect().top + window.scrollY + parseInt(window.getComputedStyle(linkItemActive).getPropertyValue('padding')),
            left: linkItemActive.getBoundingClientRect().left + window.scrollX + parseInt(window.getComputedStyle(linkItemActive).getPropertyValue('padding')),
        }
        console.log(coords);
