              ...
              <div className="hero--wrap">
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: createElementFromHTML(this.state.game.excerpt),
                  }}
                />
                ...
                <div className="slide--btn">
                  {this.state.game.steam_button !== '' && (
                    <a
                      href={this.state.game.steam_button}
                      className="steam"
                      target="_blank"
                    ...
                    >
                      ...
                      <svg
                        ...
                        viewBox="23.274 22.154 55.114 25.231"
                      >
                        <path
                          fill="#333"
                  ...
                  {this.state.game.google_button !== '' && (
                    <a
                      href={this.state.game.google_button}
                      className="google"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                  ...
                  {this.state.game.ios_button !== '' && (
                    <a href={this.state.game.ios_button} className="ios">
                      ...
                      >
                        <g>
                          <path d="M767.5,530.7C766.2,406.5,868.7,347,873.3,344.1c-57.5-84.3-147.2-95.8-179.3-97.2c-76.4-7.7-148.9,44.9-187.6,44.9c-38.6,0-98.4-43.8-161.7-42.7c-83.2,1.3-159.9,48.4-202.7,122.9c-86.4,150-22.2,372.2,62.1,493.8c41.2,59.5,90.3,126.4,154.7,124.1c62.1-2.5,85.5-40.2,160.5-40.2c75,0,96.1,40.2,161.8,38.9c66.8-1.3,109.1-60.7,150-120.4c47.3-69.1,66.7-136,67.9-139.3C897.6,728.3,768.8,679,767.5,530.7L767.5,530.7z M644.1,166.5c34.2-41.5,57.3-99,51-156.5c-49.3,2-109,32.8-144.4,74.2c-31.7,36.8-59.5,95.4-52,151.7C553.6,240.1,609.8,207.9,644.1,166.5L644.1,166.5z" />
                        </g>
                      </svg>
                    </a>
                  )}
          ...
          <div className="game-container tablet-full">
            ...
            <div className="game--text">
              ...
              <div
                ...
                dangerouslySetInnerHTML={{
                  __html: createElementFromHTML(this.state.game.content),
                }}
              />
            </div>
          </div>
          ...
          <div className="game-container mobile-full">
            <div className="game--sidebar">
              ...
              <div
                className="block--text"
                dangerouslySetInnerHTML={{
                  __html: createElementFromHTML(this.state.game.client),
                }}
              />
            </div>
            <div className="game--text w300">
              <h2>Goal</h2>
              <div
                className="block--text"
                dangerouslySetInnerHTML={{
                  __html: createElementFromHTML(this.state.game.goal),
                }}
              />
            </div>
          </div>
          ...
          <div className="game-container vertical-center between">
            <div className="game--sidebar">
              ...
              <div
                className="block--text"
                dangerouslySetInnerHTML={{
                  __html: createElementFromHTML(
                    this.state.game.after_slider_text,
                  ),
                }}
              />
            </div>
                ...
                <div className="block--bottom">
                  <div className="slide--btn">
                    {this.state.game.steam_button !== '' && (
                      <a
                        href={this.state.game.steam_button}
                        className="steam link-shadow download-link"
                        title="Download"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                    ...
                    {this.state.game.google_button !== '' && (
                      <a
                        href={this.state.game.google_button}
                        className="google link-shadow download-link"
                        title="Download"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                    ...
                    {this.state.game.ios_button !== '' && (
                      <a
                        href={this.state.game.ios_button}
                        className="ios link-shadow download-link"
                        title="Download"
                      >
                        <span>Download</span>
                        <svg
                  ...
                  <div className="article--content margin-d">
                    <div
                      dangerouslySetInnerHTML={{
                        __html: createElementFromHTML(
                          this.state.game.footer_text,
                        ),
                      }}
                    />
                  </div>
                    ...
                    <span>
                      ...
                      >
                        <g id="2—Member">
                          <g
                            id="g—member-4"
                            transform="translate(-1152.000000, -740.000000)"
                            fill="#000000"
                          >
                            <g
                              id="Scroll"
                              transform="translate(144.000000, -219.000000)"
                            >
                              <g
                                id="Arrows"
                                transform="translate(1008.000000, 959.000000)"
                              >
                                <polygon
                                  id="arrow-L"
                                  transform="translate(5.782038, 10.143818) scale(-1, 1) translate(-5.782038, -10.143818) "
                                  points="8.02417969 10.1421356 0.00336440785 2.12132034 0 0.710471189 0.708002022 0.00246916752 2.12468475 0 11.564076 9.4393912 11.5597136 10.8492424 2.12468475 20.2842712 0.713835597 20.2876357 0.00583357537 19.5796336 0.00336440785 18.1629509"
                                />
                              </g>
                            </g>
                          </g>
                    ...
                    <span>
                      <svg width="12px" height="21px">
                        <g id="2—Member">
                          <g
                            id="g—member-4"
                            transform="translate(-1285.000000, -740.000000)"
                            fill="#000000"
                          >
                            <g
                              id="Scroll"
                            ...
                            >
                              ...
                              >
                                <polygon
                                  id="arrow"
                                  points="141.02418 10.1421356 133.003364 2.12132034 133 0.710471189 133.708002 0.00246916752 135.124685 0 144.564076 9.4393912 144.559714 10.8492424 135.124685 20.2842712 133.713836 20.2876357 133.005834 19.5796336 133.003364 18.1629509"
                                />
                              </g>
                            </g>
                          </g>
