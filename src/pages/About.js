    ...
    if (member !== []) {
      ...
      function fixNav() {
        if (
          ...
          window.innerHeight + popupElement.scrollTop >= topOfAboutTextBlock
        ) {
        ...
        if (
          window.innerHeight + popupElement.scrollTop >=
          topOfAboutTextBlock + aboutTextBlock.clientHeight
        ) {
            ...
            <div className="team-container">
              <div className="team--sidebar">
                ...
                <div className="block-text">
                  <p>
                    Geeks — независимая студия
                    <br />
                    по разработке игр.
                    <br />
                    Мы занимаемся полным циклом разработки игры а так же берем
                    на себя аутсорс задачи для других студий.
                  </p>
                </div>
              </div>
                ...
                {this.state.members.map((member, index) => {
                  return (
                    <div className="team-member" key={member.id}>
                      <a
                        href="#"
                        onClick={this.showMember.bind(this)}
                        data-id={member.id}
                        data-image={`${member.photo ? member.photo.url : ''}`}
                      >
                        <h2>{member.name}</h2>
                      </a>
                      <p>{member.position}</p>
                  ...
                  <svg viewBox="0 0 868 675" version="1.1">
                    <g id="2—Member">
                      ...
                      >
                        <g
                          id="Group"
                          transform="translate(305.000000, 71.000000)"
                        >
                          <path
                ...
                <div className="popup--wrap">
                      ...
                      <svg viewBox="0 0 16 16" version="1.1">
                        <g id="2—Member">
                          ...
                          >
                            <g
                              id="Head"
                              transform="translate(65.000000, 30.000000)"
                            >
                              <g
                                id="Close"
                  ...
                  <div className="container">
                    <div className="popup--container">
                      ...
                      <div className="popup--content">
                        {this.state.skillsList.length > 0 && (
                          <div className="popup-top--skills">
                            <div className="btn-wrap align-right">
                              <button
                                className="open-skills"
                                onClick={this.toogleSkills}
                              >
                        ...
                        <div className="block-title aboutTrigger">
                          About
                          <br />
                          {this.state.member.name.split(' ')[0]}
                        </div>
                        <div
                      ...
                      <div className="popup--sidebar software">
                        <div className="popup-software">
                          ...
                          <div className="software-description">
                            <div className="article--list">
                              {this.state.softwareList.map(
                                (software, index) => {
                                  return <div key={index}>{software}</div>;
                                },
                              )}
                            </div>
                          </div>
                        ...
                        <div className="experience--list">
                          {[...Array(5)].map((element, i) => {
                            ...
                            const name = this.state.member[
                              'experience_' + index + '_name'
                            ];
                            const position = this.state.member[
                              'experience_' + index + '_position'
                            ];
                            const link = this.state.member[
                              'experience_' + index + '_link'
                            ];
                            const time = this.state.member[
                              'experience_' + index + '_time'
                            ];
                    ...
                    <div className="team--control">
                      <button
                        className="member-prev"
                        data-navigation="prev"
                        onClick={this.teamNavigation.bind(this)}
                      >
                        <span>
                          <svg
                            width="12px"
                      ...
                      <button
                        className="member-next"
                        data-navigation="next"
                        data-id={this.state.member.id}
                        onClick={this.teamNavigation.bind(this)}
                      >
                        <span>
